import { globalToken as global } from "./global";
...
export type TokenGlobalExceptColorType =
  | "big-shadow"
  | "shadow"
  | "small-shadow"
  | "show"
...
export type TokenGlobalOnlyColor = Omit<
  TokeGlobalType,
  TokenGlobalExceptColorType
>;
export type TokenGlobalOnlyColorDescription =
  | "primary"
  | "secondary"
  | "basic"
  | "semantic"
  | "chat bg";
export type TokenTypographyKeyType =
  | "h1"
  | "h2"
  | "h3"
  | "body1"
